...
export type AIGovernanceView = 'overview' | 'evaluations' | 'reviews' | 'profiles' | 'runtime' | 'configuration'

const VIEW_PATHS: Record<AIGovernanceView, string> = {
  overview: AI_GOVERNANCE_BASE_PATH,
  configuration: `${AI_GOVERNANCE_BASE_PATH}/configuration`,
...
export const AI_GOVERNANCE_NAVIGATION: Array<{ view: AIGovernanceView; label: string; description: string }> = [
  ...
  { view: 'configuration', label: '配置与草稿', description: '查看 qs-ai 配置版本，编辑并冻结 Prompt 草稿。' },
